...
export default function LandingPage() {
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <span className="font-semibold text-xl text-gray-800">La Machine Commerciale</span>
            </div>
            ...
            <div className="hidden md:block">
              <a href={calendlyLink} target="_blank" rel="noopener noreferrer">
                <button className="px-4 py-2 bg-emerald-500 text-white rounded-md hover:bg-emerald-400 transition duration-300">
                  Réservez un appel
                </button>
              </a>
            </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white px-4 pt-2 pb-4 border-b border-gray-200">
          ...
          <a href={calendlyLink} target="_blank" rel="noopener noreferrer" className="block mt-4">
            <button className="w-full px-4 py-2 bg-emerald-500 text-white rounded-md hover:bg-emerald-400 transition duration-300">
              Réservez un appel
            </button>
          </a>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <section className="text-center py-20">
          ...
          <a href={calendlyLink} target="_blank" rel="noopener noreferrer">
            <button className="px-8 py-3 bg-emerald-500 text-white rounded-md hover:bg-emerald-400 transition duration-300 text-lg font-semibold">
              Réservez un appel
            </button>
          </a>
        </section>
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="border rounded-lg p-6 shadow-md">
              ...
              <a href={calendlyLink} target="_blank" rel="noopener noreferrer">
                <button className="w-full px-4 py-2 bg-emerald-500 text-white rounded-md hover:bg-emerald-400 transition duration-300 mb-4">
                  Réservez un appel
                </button>
              </a>
